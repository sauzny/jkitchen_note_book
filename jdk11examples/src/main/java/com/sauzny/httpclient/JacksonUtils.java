...
public final class JacksonUtils {
    ...
    private static class NonNull {  
        ...
        static {  
            // 序列化时 忽略 null
            instance = new JacksonUtils(Include.NON_NULL);  
        }  
    }  
    ...
    private static class NonEmpty {  
        ...
        static {  
            // 序列化时 忽略 null 空字符串
            instance = new JacksonUtils(Include.NON_EMPTY);  
        }  
    }
    ...
    private static class NonDefault {  
        ...
        static {  
            // 序列化时 忽略 null 空字符串 0
            instance = new JacksonUtils(Include.NON_DEFAULT);  
        }  
    }
    ...
    // 序列化时 忽略 null 空字符串 0
    public static JacksonUtils nonDefault() {
