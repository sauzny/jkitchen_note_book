...
public final class IpMaskUtils {
    ...
    public static String getMaskByMaskBit(String maskBit) {
        return maskBit == null ? "error, maskBit is null !" : maskBitMap().get(maskBit);
    }
    ...
    public static String getBeginIpStr(String ip, String maskBit) {
        return IpConvert.getIpFromLong(getBeginIpLong(ip, maskBit));
    }
    ...
    public static Long getBeginIpLong(String ip, String maskBit) {
        return IpConvert.getIpFromString(ip) & IpConvert.getIpFromString(getMaskByMaskBit(maskBit));
    }
    ...
    public static String getEndIpStr(String ip, String maskBit) {
        return IpConvert.getIpFromLong(getEndIpLong(ip, maskBit));
    }
    ...
    public static Long getEndIpLong(String ip, String maskBit) {
        return getBeginIpLong(ip, maskBit) + IpConvert.getIpFromString(getMaskByMaskBit(maskBit));
    }
